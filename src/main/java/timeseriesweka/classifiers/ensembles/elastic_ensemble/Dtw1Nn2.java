 ...
 */
public class Dtw1Nn2 extends Efficient1NN{
...
//        String datasetName = "SonyAiboRobotSurface1";
    ...
    public static void parseResult() throws Exception{
        String dir = "/gpfs/home/sjx07ngu/George/results/DTW_Rn_1NN/";
        for(String dataset: DataSets.fileNames){
            System.out.print(dataset+",");
            try{
                Scanner scan = new Scanner(new File(dir+dataset+"/testFold0.csv"));
                scan.useDelimiter("\n");
                scan.next();
                scan.next();
...
//        int jobId = Integer.parseInt(args[0].trim())-1;
//        String tscProbDir = "/gpfs/home/sjx07ngu/TSC Problems/";
//        String datasetName = DataSets.fileNames[jobId];

        String tscProbDir = "/scratch/TSCProblems2018/";
...
//        double r = 0.1;
        ...
        ElasticEnsemble ee = new ElasticEnsemble(new ElasticEnsemble.ConstituentClassifiers[]{ElasticEnsemble.ConstituentClassifiers.DTW_Rn_1NN});
        ee.setInternalFileWritingOn("results/", datasetName, 0);
        ee.buildClassifier(train);

        new File("results/DTW_Rn_1NN/"+datasetName+"/").mkdirs();
        ee.writeTestResultsToFile(test, datasetName, "EE", ee.getParameters(), "results/DTW_Rn_1NN/"+datasetName+"/testFold0.csv");
