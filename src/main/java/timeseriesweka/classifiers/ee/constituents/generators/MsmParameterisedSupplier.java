...
public class MsmParameterisedSupplier extends ParameterisedSupplier<Msm> {

    private final IndexedMutator<Msm, Double> warpingWindowParameter = new IndexedMutator<>(Msm.WARPING_WINDOW_MUTABLE);
    private final TargetedMutator<Msm> warpingWindowMutator = new TargetedMutator<>(warpingWindowParameter, getBox());
    private final IndexedMutator<Msm, Double> costParameter = new IndexedMutator<>(Msm.COST_MUTABLE);
    private final TargetedMutator<Msm> costMutator = new TargetedMutator<>(costParameter, getBox());

    public MsmParameterisedSupplier() {
