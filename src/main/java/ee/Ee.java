...
import ee.iteration.RandomIterator;
import ee.parameter.ParameterPermutation;
import ee.parameter.ParameterPermutationPool;
import ee.parameter.ParameterPool;
import ee.parameter.RandomParameterPermutationIterator;
...
public class Ee
    //extends AdvancedAbstractClassifier implements Randomised
    {
...
//            for(Function<ConstituentParameters, Constituent> obtainer : consituentBuilders) {
//                constituents.add(obtainer.apply(new ConstituentParameters(trainInstances, random)));
//            }
...
//                System.out.println(" " + Utilities.join(abstractClassifier.getOptions(), ", "));
//            } else {
//                System.out.println();
//            }
...
//    private final List<Function<ConstituentParameters, Constituent>> consituentBuilders = new ArrayList<>();

//    public static class IndexedIterableParameters<A> {
//        public final IndexedIterable<A> indexedIteratable;
//        public final Random random;
//
//        public IndexedIterableParameters(IndexedIterable<A> indexedIteratable, Random random) {
//            this.indexedIteratable = indexedIteratable;
//            this.random = random;
//        }
//    }

    public static class ConstituentParameters {
        public final Instances instances;
        public final Random random;

        public ConstituentParameters(Instances instances, Random random) {
...
//                                      Function<ConstituentParameters, ParameterPoolInterface> parameterPoolObtainer,
//                                      Function<IndexedIterableParameters<ParameterPermutation>, Iterator<ParameterPermutation>> iteratorObtainer) {
//        consituentBuilders.add(constituentParameters -> {
//            ParameterPoolInterface parameterPool = parameterPoolObtainer.apply(constituentParameters);
//            Iterator<ParameterPermutation> iterator = iteratorObtainer.apply(new IndexedIterableParameters<>(parameterPool, constituentParameters.random));
//            return new Constituent(classifierSupplier, iterator);
//        });
//    }
//
//    public static ParameterPoolInterface getDtwParameterPool(Instances instances) {
//        int instanceLength = instances.numAttributes() - 1;
//        ParameterPool parameterPool = new ParameterPool();
//        parameterPool.addParameter(new DiscreteParameterPool<>(Dtw.WARPING_WINDOW_KEY, incrementalDiffListInt(0, instanceLength, 100)));
//        return parameterPool;
//    }
//
//    public static ParameterPoolInterface getLcssParameterPool(Instances instances) {
//        ParameterPool parameterPool = new ParameterPool();
//        int instanceLength = instances.numAttributes() - 1;
//        instanceLength *= 0.25;
//        parameterPool.addParameter(new DiscreteParameterPool<>(Lcss.WARPING_WINDOW_KEY, incrementalDiffListInt(0, instanceLength, 10)));
//        double maxTolerance = StatisticUtilities.populationStandardDeviation(instances);
//        double minTolerance = maxTolerance * 0.2;
//        parameterPool.addParameter(new DiscreteParameterPool<>(Lcss.TOLERANCE_KEY, incrementalDiffList(minTolerance, maxTolerance, 10)));
//        return parameterPool;
//    }
//
//    public static ParameterPoolInterface getErpParameterPool(Instances instances) {
//        ParameterPool parameterPool = new ParameterPool();
//        int instanceLength = instances.numAttributes() - 1;
//        instanceLength *= 0.25;
//        parameterPool.addParameter(new DiscreteParameterPool<>(Erp.WARPING_WINDOW_KEY, incrementalDiffListInt(0, instanceLength, 10)));
//        double maxPenalty = StatisticUtilities.populationStandardDeviation(instances);
//        double minPenalty = maxPenalty * 0.2;
//        parameterPool.addParameter(new DiscreteParameterPool<>(Erp.PENALTY_KEY, incrementalDiffList(minPenalty, maxPenalty, 10)));
//        return parameterPool;
//    }
//
//    public static ParameterPoolInterface getTweParameterPool(Instances instances) {
//        ParameterPool parameterPool = new ParameterPool();
//        parameterPool.addParameter(new DiscreteParameterPool<>(Twe.PENALTY_KEY, new ArrayList<>(Arrays.asList(0d,
//                0.011111111,
//                0.022222222,
//                0.033333333,
//                0.044444444,
...
//                0.088888889,
//                0.1))));
//        parameterPool.addParameter(new DiscreteParameterPool<>(Twe.STIFFNESS_KEY, new ArrayList<>(Arrays.asList(0.00001,
//                0.0001,
//                0.0005,
//                0.001,
//                0.005,
...
//    }
//
//    public static ParameterPoolInterface getMsmParameterPool(Instances instances) {
//        ParameterPool parameterPool = new ParameterPool();
//        parameterPool.addParameter(new DiscreteParameterPool<>(Msm.PENALTY_KEY, new ArrayList<>(Arrays.asList(
//                0.01,
//                0.01375,
//                0.0175,
//                0.02125,
...
//    }
//
//    public static ParameterPoolInterface getWdtwParameterPool(Instances instances) {
//        ParameterPool parameterPool = new ParameterPool();
//        parameterPool.addParameter(new DiscreteParameterPool<>(Wdtw.WEIGHT_KEY, Utilities.linearInterpolate(100, 100)));
//        return parameterPool;
//    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        ParameterPermutationPool pool = new ParameterPermutationPool();
        pool.addParameterPool(Lcss.TOLERANCE_KEY, tolerance);
        pool.addParameterPool(Lcss.WARPING_WINDOW_KEY, warpingWindow);
        RandomParameterPermutationIterator randomIterator = new RandomParameterPermutationIterator(pool, new Random(0), 10);
...
//        Ee ee = new Ee();
//        String datasetsDir = "/home/goastler/TSCProblems2018";
//        String datasetName = "Wafer";
//        int seed = 0;
