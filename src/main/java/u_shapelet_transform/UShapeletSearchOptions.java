...
import timeseriesweka.filters.shapelet_transforms.search_functions.ShapeletSearchOptions.Builder;
import u_shapelet_transform.UShapeletSearch.SearchType;

public class UShapeletSearchOptions {
	public int getMin() {
        return min;
    }
    ...
    protected UShapeletSearchOptions(Builder ops){
        min = ops.min;
        max = ops.max;
        seed = ops.seed;
    ...
    public static class Builder{
        ...
        public UShapeletSearchOptions build(){
            setDefaults();
            return new UShapeletSearchOptions(this);
        }
